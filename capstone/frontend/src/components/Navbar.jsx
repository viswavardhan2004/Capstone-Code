    ...
    >
      ...
      >
        ...
        <div className="hidden md:flex gap-4 items-center">
          ...
          {isLoggedIn && userType === 'admin' && (
            <a href="http://localhost:5174/admin/fraud-alerts" className="relative bg-gradient-to-r from-red-500/20 to-pink-500/20 text-red-400 px-4 py-2.5 rounded-xl hover:from-red-500/30 hover:to-pink-500/30 transition-all flex items-center gap-2 border border-red-500/30 shadow-lg hover:shadow-red-500/50 group overflow-hidden">
        ...
        {showMobileMenu && (
          <div className="md:hidden fixed top-20 right-4 w-72 bg-brand-card border border-white/20 shadow-2xl rounded-2xl max-h-[calc(100vh-120px)] overflow-y-auto z-50">
            <div className="px-4 py-6 flex flex-col gap-1">
              ...
              {isLoggedIn && userType === 'admin' && (
                <a 
                  href="http://localhost:5174/admin/fraud-alerts" 
